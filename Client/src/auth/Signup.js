...
const Signup = ()=>{
    ...
    const {contactNumber} = signupDetails
          axios.get(`https://2factor.in/API/V1/${api_key}/SMS/${contactNumber}/AUTOGEN/OTP+Verification`)
          .then((response)=>{
      ...
      const validateOTP = () => {
        const {contactNumber} = signupDetails
        axios.get(`https://2factor.in/API/V1/${api_key}/SMS/VERIFY3/${contactNumber}/${otp}`)
            .then(data => {
              if(data){
                console.log(data)
